  ...
  try {
    ...
    const mockProducts: HttpTypes.StoreProduct[] = [
      ...
      },
      {
        ...
        description: "The ancient Chinese oracle text, translated by Richard Wilhelm with foreword by Carl Jung.",
        handle: "i-ching-wilhelm",
        is_giftcard: false,
        status: "published",
        thumbnail: "https://covers.openlibrary.org/b/isbn/9780691018720-L.jpg",
        weight: 1800,
        variants: [{
          id: "variant_01HFGYQM87RC02GQGX47GZS9V13",
          title: "Wilhelm Translation",
          sku: "ICHING-WILHELM-001",
          inventory_quantity: 8,
          calculated_price: {
            calculated_amount: 14500,
            original_amount: 14500,
            currency_code: "gbp",
          }
        }],
        options: [],
        images: [{ url: "https://covers.openlibrary.org/b/isbn/9780691018720-L.jpg" }],
        tags: [],
        categories: []
      } as any,
      {
      ...
      } as any,
      {
        ...
        description: "The personal philosophical reflections of the Roman Emperor, a cornerstone of Stoic philosophy.",
        handle: "meditations-aurelius",
        is_giftcard: false,
        status: "published",
        ...
        variants: [{
          ...
          title: "Penguin Classics Edition",
          sku: "AURELIUS-MED-001",
        ...
        options: [],
        images: [{ url: "https://covers.openlibrary.org/b/isbn/9780140449334-L.jpg" }],
        tags: [],
        categories: []
      } as any,
      {
